...
export default function ProgramRow({ title, programs, large = false, onSelect, onRemove }) {
  ...
  return (
    <div className="mb-10 relative group">
      {title && <h2 className="text-xl md:text-2xl font-bold text-white mb-4 pl-4 md:pl-0 tracking-tight">{title}</h2>}
