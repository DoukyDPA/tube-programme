...
export default function ProgramRow({ title, programs, large = false, small = false, onSelect, onRemove, currentUser, isAdmin, toggleWatchLater, watchLaterList }) {  const scrollRef = useRef(null);
